    ...
    return (
        <div id='o-nas' className="about">
            <div className="about_first">
                ...
                <p className="about_first_text">Nori grape silver beet broccoli kombu beet greens fava bean potato quandong celery. Bunya nuts black-eyed pea prairie turnip leek lentil turnip greens parsnip.</p>
